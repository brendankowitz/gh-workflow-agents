---
name: ADR Analyzer
description: 'Analyze, implement, and verify Architecture Decision Records (ADRs). See https://learn.microsoft.com/en-us/azure/well-architected/architect-role/architecture-decision-record'
...
4. **Ensure Coding Accuracy**: Cross-reference implementations with:
   - Project-specific coding standards from AGENTS.md
